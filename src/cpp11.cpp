...
extern "C" SEXP _concavetest_cpp_concaveman(SEXP xy, SEXP hull_in, SEXP concavity, SEXP lengthThreshold) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_concavetest_cpp_concaveman", (DL_FUNC) &_concavetest_cpp_concaveman, 4},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_concavetest(DllInfo* dll){
